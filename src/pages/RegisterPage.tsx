...
import { Eye, EyeOff, BarChartBig, ChevronDown, Globe, Check, Mail } from 'lucide-react';
...
const TERMS_TEXT = `By accessing the IDH Salary Matrix platform, you agree to use this service solely for the purpose of monitoring and improving living wage compliance across your supply chain. All data shared through this platform is subject to producer consent and may only be used for internal reporting and supplier engagement purposes.

You agree not to share, redistribute, or commercialise producer wage data without explicit written consent from the data owner. IDH reserves the right to suspend access to any buyer found in breach of these terms. All data is processed in accordance with GDPR and applicable data protection legislation.
...
export default function RegisterPage() {
  ...
  // const canSubmit = fullName.trim().length > 0 && strength >= 2 && passwordMatch && termsAccepted;
  ...
  return (
    <div className="min-h-screen flex font-sans" style={{ paddingTop: DEMO_BAR_HEIGHT }}>
      <div className="hidden lg:flex lg:w-5/12 xl:w-[42%] bg-primary-500 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <div className="inline-flex items-center gap-2 bg-white bg-opacity-15 rounded-full px-4 py-2">
            <Mail className="w-4 h-4 text-white opacity-80" />
            <span className="text-white text-sm opacity-90 font-medium">You have been invited</span>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          {submitted ? (
            ...
            <div className="mb-7">
              ...
              <p className="text-gray-500 mt-1 text-sm">Complete the form below to activate your access</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  >
                    ...
                    <div className="px-6 py-4 border-t border-gray-100 flex gap-3">
                      <button
                        ...
                        className="flex-1 bg-primary-500 hover:bg-primary-600 text-white font-semibold py-2.5 rounded-xl text-sm transition"
                      >
                        Accept &amp; close
                      </button>
                      <button
              ...
              <button
                ...
                className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-150 text-sm shadow-sm mt-1 ${
                  canSubmit
                    ? 'bg-primary-500 hover:bg-primary-600 active:bg-primary-700 text-white hover:shadow-md cursor-pointer'
