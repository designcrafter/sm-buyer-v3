      ...
      <main className="flex-1 overflow-y-auto">
        <div className="px-8 py-7 max-w-6xl mx-auto space-y-5 print:px-0 print:py-0 print:max-w-full">
          ...
          <FilterBar
            ...
            allFacilityNames={filters.allFacilityNames}
            allFacilityIds={filters.allFacilityIds}
            selectedCountries={filters.selectedCountries}
            selectedRegions={filters.selectedRegions}
            selectedYears={filters.selectedYears}
            selectedFacilityNames={filters.selectedFacilityNames}
            selectedFacilityIds={filters.selectedFacilityIds}
            onToggleCountry={filters.toggleCountry}
            onToggleRegion={filters.toggleRegion}
            onToggleYear={filters.toggleYear}
            onToggleFacilityName={filters.toggleFacilityName}
            onToggleFacilityId={filters.toggleFacilityId}
