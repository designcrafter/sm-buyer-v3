...
export default function IntermediaryFacilityDetailPage() {
  ...
  const statusMapping: Record<string, string> = {
    'Not Started': 'Submission',
    'Draft': 'Draft',
    'Submitted': 'Submitted',
    'Final Report': 'Final Report',
  };

  const mappedStatus = statusMapping[facility.reportStatus] || 'Submission';
  const currentStatusIndex = STATUS_STEPS.indexOf(mappedStatus);
        ...
        <div className="px-8 py-7 max-w-6xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100">
              ...
              <p className="text-sm text-gray-400 mt-1">Current status: {facility.reportStatus}</p>
            </div>
            <div className="p-6">
