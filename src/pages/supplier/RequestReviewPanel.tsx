      ...
      <>
        ...
        <div className="fixed top-0 right-0 bottom-0 w-full max-w-lg bg-white z-50 shadow-2xl flex flex-col overflow-hidden animate-slide-in-right">
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs font-semibold ${request.requested.requestAuditData ? 'text-primary-600' : 'text-gray-400'}`}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs font-semibold ${request.requested.requestVoluntaryContribution ? 'text-primary-600' : 'text-gray-400'}`}>
          ...
          <div className="px-6 py-4 border-t border-gray-100 flex items-center gap-3 shrink-0">
            ...
            <button
              onClick={onAccept}
              className="px-5 py-2.5 rounded-xl bg-primary-700 hover:bg-primary-800 text-white text-sm font-semibold transition shadow-sm"
            >
              Accept Request
            </button>
          </div>
      ...
      <div className="fixed top-0 right-0 bottom-0 w-full max-w-lg bg-white z-50 shadow-2xl flex flex-col overflow-hidden animate-slide-in-right">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl border border-gray-200 px-5 py-4">
              <div className="flex items-center gap-2 mb-3">
                <Calendar className="w-4 h-4 text-primary-600" strokeWidth={1.75} />
            ...
            <div className="bg-white rounded-xl border border-gray-200 px-5 py-4 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <ClipboardCheck className="w-4 h-4 text-primary-600" strokeWidth={1.75} />
                ...
                <button
                  ...
                  className={`relative inline-flex items-center shrink-0 rounded-full transition-colors ${
                    auditData ? 'bg-primary-600' : 'bg-gray-200'
                  }`}
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-primary-700 hover:bg-primary-800 text-white text-sm font-semibold transition shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Update Access
          </button>
        </div>
