...
const DEMO_INVITES: BuyerInvite[] = [
  {
    ...
    contactEmail: 'anna.lindqvist@hm.com',
    receivedAt: '2 hours ago',
  },
  {
    id: 'inv-2',
    buyerName: 'Carrefour Group',
    buyerInitials: 'CG',
    contactName: 'Pierre Moreau',
    contactEmail: 'p.moreau@carrefour.com',
...
const DEMO_RELATIONSHIPS: BuyerRelationship[] = [
  {
    id: 'rel-1',
    buyerName: 'Lidl International',
    buyerInitials: 'LI',
    contactName: 'Thomas Bauer',
    contactEmail: 't.bauer@lidl.com',
    suppliersManaged: 12,
    since: 'Jan 2025',
  },
  {
    id: 'rel-2',
    buyerName: 'Zalando SE',
    buyerInitials: 'ZA',
    contactName: 'Sophie Meier',
    contactEmail: 's.meier@zalando.de',
    suppliersManaged: 8,
    since: 'Mar 2025',
  },
];
